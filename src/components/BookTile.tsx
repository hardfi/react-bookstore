        ...
        <Grid container item xs={4} sm={3} md={2} justify='space-between' direction='column'>
            ...
            <Grid container item direction='column'>
                <Grid container item alignItems='center' justify='space-between'>
                    {userRole === USER_ROLE.client && <Grid container item direction='column'>
                        ...
                        <Grid className='mt--2'>
                          <h6 className={classes.header}>{selectedBook.quantity} available</h6>
                        </Grid>
                    </Grid>}
                    {userRole === USER_ROLE.admin && <Grid container item justify='center'>
